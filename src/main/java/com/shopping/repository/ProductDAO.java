...
public class ProductDAO {
	...
	private final String INSERT_QUERY = "INSERT INTO PRODUCT (RECORD_ID,NAME, QUANTITY,PRICE,SKU,DEPARTMENT_ID,DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE) VALUES (:RECORD_ID,:NAME,:QUANTITY,:PRICE,:SKU,:DEPARTMENT_ID,:DESCRIPTION,:CREATED_BY,NOW(),:MODIFIED_BY,NOW())";
	private final String SELECT_ALL_QUERY = "SELECT RECORD_ID,NAME, QUANTITY,PRICE,SKU,DEPARTMENT_ID,DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE FROM PRODUCT ";
	private final String SELECT_BY_ID_QUERY = "SELECT RECORD_ID,NAME, QUANTITY,PRICE,SKU,DEPARTMENT_ID,DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE FROM PRODUCT WHERE RECORD_ID = :RECORD_ID";
	private final String UPDATE_QUERY = "UPDATE PRODUCT SET RECORD_ID=:RECORD_ID,NAME=:NAME, QUANTITY=:QUANTITY,PRICE=:PRICE,SKU=:SKU,DEPARTMENT_ID=:DEPARTMENT_ID,DESCRIPTION=:DESCRIPTION,MODIFIED_BY=:MODIFIED_BY,MODIFIED_DATE=:MODIFIED_DATE  WHERE RECORD_ID = :RECORD_ID";
	...
	public ProductDTO create(ProductDTO productDTO) {
		...
		SqlParameterSource namedParameters = new MapSqlParameterSource()
				...
				.addValue("CREATED_BY", productDTO.getCreatedBy())
				.addValue("CREATED_DATE", productDTO.getCreatedDate())
