...
public class ProductDAO {
	...
	private static final String INSERT_QUERY = "INSERT INTO PRODUCT (NAME, QUANTITY,PRICE,SKU,DEPARTMENT_ID,DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE) VALUES (:NAME,:QUANTITY,:PRICE,:SKU,:DEPARTMENT_ID,:DESCRIPTION,:CREATED_BY,NOW(),:MODIFIED_BY,NOW())";
	private static final String SELECT_ALL_QUERY = "SELECT ID,NAME, QUANTITY,PRICE,SKU,DEPARTMENT_ID,DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE FROM PRODUCT ";
	private static final String SELECT_BY_ID_QUERY = "SELECT ID,NAME, QUANTITY,PRICE,SKU,DEPARTMENT_ID,DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE FROM PRODUCT WHERE ID = :ID";
