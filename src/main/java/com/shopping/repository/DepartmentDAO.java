...
public class DepartmentDAO {
	...
	private final String INSERT_QUERY = "INSERT INTO DEPARTMENT (DEPARTMENT_NAME,DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE) VALUES (:DEPARTMENT_NAME,:DESCRIPTION,:CREATED_BY,NOW(),:MODIFIED_BY,NOW())";
	private final String SELECT_ALL_QUERY = "SELECT ID,DEPARTMENT_NAME, DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE FROM DEPARTMENT ";
	private final String SELECT_BY_ID_QUERY = "SELECT ID,DEPARTMENT_NAME, DESCRIPTION,CREATED_BY,CREATED_DATE,MODIFIED_BY,MODIFIED_DATE FROM DEPARTMENT WHERE ID = :ID";
	private final String UPDATE_QUERY = "UPDATE DEPARTMENT SET DEPARTMENT_NAME=:DEPARTMENT_NAME, DESCRIPTION=:DESCRIPTION,MODIFIED_BY=:MODIFIED_BY,MODIFIED_DATE=:MODIFIED_DATE WHERE ID = :ID";
